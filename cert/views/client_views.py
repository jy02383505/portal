...
def client_cert_ssl_manage_views(request):
    """客户端证书管理页面"""
    res = {
...
@login_required
@rights_required('client_cdn_cert_manage')
def client_cert_create_views(request):
    """客户端证书创建页面"""
...
@login_required
@rights_required('client_cdn_cert_manage')
def client_cert_edit_views(request, cert_name, user_id):
    """客户端证书修改页面"""
...
@login_required
@rights_required('client_cdn_cert_manage')
def client_cert_detail_views(request, cert_name, user_id):
    """客户端证书详情页面"""
